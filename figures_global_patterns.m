...
% Paths
data_path = 'F:\GLEAM4\'; % Path to data files
...
if redo == 1
    ...
    variables = {'E', 'Ep', 'Ep_aero', 'Ep_rad', 'Et', 'Ec', 'Eb', 'Ew', 'Ei', 'Es', 'S', 'SMroot', 'SH'};
    ...
    for year = 1980:2023
        ...
        for var = variables
            varname = char(var);
            filename = [data_path, yr, '\', varname, '_', yr, '_GLEAM_v4.1a.nc'];
...
map_and_save(SMroot_JJA, [-0.017 1], S == 0, [data_path, 'SMroot_JJA.jpg']);
map_and_save(SMroot_DJF, [-0.017 1], S == 0, [data_path, 'SMroot_DJF.jpg']);
SH_JJA(SH_JJA < 0) = 0; SH_DJF(SH_DJF < 0) = 0; % Set negative values to zero
map_and_save(SH_JJA, [-2.2 120], S == 0, [data_path, 'H_JJA.jpg']);
map_and_save(SH_DJF, [-2.2 120], S == 0, [data_path, 'H_DJF.jpg']);
